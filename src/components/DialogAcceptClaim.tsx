...
import {acceptClaim} from "@/service/Dispute.tsx"; // Assuming you have a service to handle this
...
export function DialogAcceptClaim({isDialogOpen, setIsDialogOpen, disputeID, onResponse}: {
	...
	const onSubmit = async (data: FormValues) => {
		try {
			setLoading(true);
			const response = await acceptClaim(disputeID, data.note);
			if (response) {
